...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //init alert views
	prompt_connecting = [UIAlertController alertControllerWithTitle:@"UniMag"
...
- (void)umConnection_starting:(NSNotification *)notification {
    //[prompt_connecting setModalPresentationStyle:UIModalPresentationPopover];
    //[prompt_connecting addAction:okAction];
...
- (void)umSwipe_starting:(NSNotification *)notification {
    ...
    //[prompt_waitingForSwipe setModalPresentationStyle:UIModalPresentationPopover];
    //[prompt_waitingForSwipe addAction:okAction];
