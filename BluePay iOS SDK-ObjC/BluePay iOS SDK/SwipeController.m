...
{
	UIAlertController *prompt_connecting;
	UIAlertController *prompt_waitingForSwipe;
}
...
NSString *ksnString;
NSString *track1EncryptedString;
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    //init alert views
    prompt_connecting = [UIAlertController alertControllerWithTitle:@"UniMag" message:@"Connecting with UniMag."
        preferredStyle:UIAlertControllerStyleAlert];
	
    prompt_waitingForSwipe = [UIAlertController alertControllerWithTitle:@"UniMag"
                                                                                    message:@"\n\n" preferredStyle:UIAlertControllerStyleAlert];
    UIAlertAction *cancel_action = [UIAlertAction actionWithTitle:@"Cancel" style:UIAlertActionStyleDefault
                                                   handler:^(UIAlertAction * action) {
                                                       [uniReader cancelTask];
                                                       [prompt_waitingForSwipe dismissViewControllerAnimated:YES completion:nil];
                                                   }];
    [prompt_waitingForSwipe addAction:cancel_action];
...
- (void)alertView:(const UIAlertController *)alertView didDismissWithButtonIndex:(NSInteger)buttonIndex{
...
- (void)umConnection_starting:(NSNotification *)notification {
    ...
    NSLog(@"SDFSDFD");
    [self presentViewController:prompt_connecting animated:YES completion:nil];
    NSLog(@"SDFDSFDSFDSFDSF");
}
...
- (void)umSwipe_starting:(NSNotification *)notification {
    ...
    [self presentViewController:prompt_waitingForSwipe animated:YES completion:nil];
...
- (void)umSwipe_receivedSwipe:(NSNotification *)notification {
    ...
    track1EncryptedString = [[[[cd.track1_encrypted description]
                               stringByReplacingOccurrencesOfString: @"<" withString: @""]
                              stringByReplacingOccurrencesOfString: @">" withString: @""]
                             stringByReplacingOccurrencesOfString: @" " withString: @""];
    
    track1String = [[[[repr(tracks[0]) description]
                      stringByReplacingOccurrencesOfString: @"<" withString: @""]
                     stringByReplacingOccurrencesOfString: @">" withString: @""]
                    stringByReplacingOccurrencesOfString: @" " withString: @""];
    
    ksnString = [[[[cd.KSN description]
                   stringByReplacingOccurrencesOfString: @"<" withString: @""]
                  stringByReplacingOccurrencesOfString: @">" withString: @""]
                 stringByReplacingOccurrencesOfString: @" " withString: @""];
    
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"Swipe Result"
                                                                             message:@""
                                                                      preferredStyle:UIAlertControllerStyleAlert];
    ...
    NSDictionary *customerInformation = @{
                                          ...
                                          @"Email" : @"",
                                          @"Amount" : transAmount,
                                          @"EncryptedTrack1" : track1EncryptedString,
                                          @"Track1Length"  : [NSNumber numberWithInteger:[track1String length]],
                                          @"KSN" : ksnString
                                          };
    NSError *jsonError;
...
-(void) showAlertView:(NSString*)msg {
    ...
    UIAlertController *alertView = [UIAlertController
                                     alertControllerWithTitle:@"UniMag"
                                     message:msg
                                     preferredStyle:UIAlertControllerStyleAlert];
