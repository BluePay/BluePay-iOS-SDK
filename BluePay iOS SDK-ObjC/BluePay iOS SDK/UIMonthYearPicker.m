...
- (void) setMaximumDate:(NSDate *)aMaximumDate{
    ...
    NSDateComponents *components = [[NSCalendar currentCalendar] components:NSCalendarUnitCalendar fromDate:aMaximumDate];
...
- (void) setMinimumDate:(NSDate *)aMinimumDate{
    NSDateComponents *components = [[NSCalendar currentCalendar] components:NSCalendarUnitCalendar fromDate:aMinimumDate];
...
- (void) setDate:(NSDate *)aDate animated:(BOOL)animated{
    ...
    NSDateComponents *components = [[NSCalendar currentCalendar] components:NSCalendarUnitCalendar fromDate:aDate];
    dateMonth = [components month];
    components = [[NSCalendar currentCalendar] components:NSCalendarUnitCalendar fromDate:aDate];
